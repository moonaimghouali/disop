...
const Sidebar = () => {
  ...
  if (user.userInfo.role === roles.Unite) Links = uniteLinks;
  if (user.userInfo.role === roles.RespUnite) Links = respUniteLinks;
  ...
  if (user.userInfo.role === roles.RespRegion) Links = RespRegionLinks;
