...
import { ChartProduction, ChartEvolution, ChartContribution, GlobalInformation, Stats} from '../../dp/charts'
import * as api from '../../../api/dpApi'
import { formatStats } from '../../dp/tdb/helpful'
  ...
  const RegionId = useSelector((state)=> state.system.id)
    ...
    useEffect(()=>{
      const fn = async() =>{
        ...
        let res = await api.fetchRegionDailyData(journee, RegionId)      
