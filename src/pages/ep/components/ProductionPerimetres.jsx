...
const ProductionPerimetres = ({prod, perimetres}) => {

  useEffect(()=>{
    console.log("asask",typeof(prod), prod)
  },[])

  return (
    <>
    <div className='font-semibold text-xl mb-3 ml-2'>Production des Puits par Perimetres</div>
...
export default ProductionPerimetres